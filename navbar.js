 ...
 <div id="detaisd">
    ...
    <div class="dropdown" id="Deals">
        ...
        <div class="dropdown-content" id="Deals_dropdown">
            ...
            <div id="del_img">
                <img src="./navbar/deals_img.png" alt="">
            </div>
        </div>
    </div>
    <div class="dropdown">
    ...
    <div class="dropdown" id="connect">
        ...
        <div class="dropdown-content" id="connect_dropdown">
            <img src="./navbar/mumbai.png" alt="">
            <img src="./navbar/hyderabad.png" alt="">
            <img src="./navbar/pune.png" alt="">
            <img src="./navbar/chennai.png" alt="">
            <img src="./navbar/india.png" alt="">
        </div>
    </div>
    <div class="dropdown" id="info">
        <a class="dropbtn">Info</a>
        <div class="dropdown-content" id="info_dropdown">
            <img src="./navbar/info.png" alt="">
        </div>
    </div>
    <div class="dropdown">

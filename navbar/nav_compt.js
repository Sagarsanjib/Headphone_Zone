...
var data_phone=[
    {
        imge_url:"https://cdn.shopify.com/s/files/1/0153/8863/products/Headphone-Zone-KZ-ZSN-Pro-X-Black-03_400x.jpg?v=1623407931",
        name:"KS - ZEN PRO X",
    ...
    {
        imge_url:"https://cdn.shopify.com/s/files/1/0153/8863/products/Headphone-Zone-CCA-CRA-Black-5_400x.jpg?v=1648213897",
        name:"CCA-CRA",
        price:"1,399",
        Categories:"earphone",
        strikeprice:"225662",
    ...
    {
        imge_url:"https://cdn.shopify.com/s/files/1/0153/8863/products/Headphone-Zone-CCA-C10pro-Black-02_400x.jpg?v=1627994425",
        name:"CCA-C10 PRO",
        price:"2,999",
        Categories:"earphone",
        strikeprice:"2222",
    ...
    {
        imge_url:"https://cdn.shopify.com/s/files/1/0153/8863/products/e3a79da181084931a081e08bdc1a971a_d1c7fa15-f9e1-470e-9fd1-64d86df31cff_400x.jpg?v=1623654199",
        name:"KZ-ZST X",
        price:"1,399",
        Categories:"earphone",
        strikeprice:"2222",
...
function closeNav() {
  ...
  function searchitem(){
      ...
      dis.innerHTML=""
                        ...
                        var pd2=document.createElement("b")
                        pd2.innerText="JOURNAL"
    ...
    //   console.log(search_value)
      data_phone.forEach(e => {
          if(search_value==e.Categories){
            ...
            // var itemdiv_img=document.createElement("div")
            itemdiv.setAttribute("id","sear_item_dis")
            var item_image=document.createElement("img")
            item_image.src=e.imge_url
            var item_name=document.createElement("b")
            item_name.innerText=e.name
            
            var item_price=document.createElement("p")
            item_price.innerText=`₹ ${e.price}`
            itemdiv.append(item_image,item_name,item_price)
            dis.append(itemdiv)
